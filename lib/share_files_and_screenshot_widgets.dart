...
class ShareFilesAndScreenshotWidgets {
  static const MethodChannel _channel = const MethodChannel('channel:share_files_and_screenshot_widgets');

  /// for share related text
  static void text(String title, String text, String mimeType) {
    Map argsMap = <String, String>{'title': '$title', 'text': '$text', 'mimeType': '$mimeType'};
  ...
  static Future<void> file(String title, String name, List<int> bytes, String mimeType, {String text = ''}) async {
    Map argsMap = <String, String>{'title': '$title', 'name': '$name', 'mimeType': '$mimeType', 'text': '$text'};
  ...
  Future<Image> takeScreenshot(GlobalKey previewContainer, int originalSize) async {
  ...
  shareScreenshot(GlobalKey previewContainer, int originalSize, String title, String name, String mimeType, {String text = ''}) async {
    final currentContext = previewContainer.currentContext;
    if (currentContext == null) {
      return;
    }
  ...
  shareFile(String title, String name, Uint8List bytes, String mimeType, {String text = ''}) async {
    try {
